 ...
 * HeartsPlayer at regular intervals.  It can be used, for example, in games
 * where players have deadlines for performing certain actions (e.g., chess
 * clock, 24-second clock in a basketball simultation).<P>
 * 
 * Each HeartsLocalGame, HeartsHumanPlayer and ComputerPlayer has a GameTimer created
